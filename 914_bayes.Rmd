...
# ---- extract table keeping variable names ----
table1_df <- print(
  table1,
  quote = FALSE,
  noSpaces = TRUE,
...
for (i in seq_len(nrow(fits_index))) {
  ...
  # Run the diagnostic function and save it to the list
...
diag_stats_df <- bind_rows(all_diag_stats) 
...
write.csv(diag_stats_df, file.path(results_PATH, "bayes_reporting_diagnostics.csv"), row.names = FALSE) 
