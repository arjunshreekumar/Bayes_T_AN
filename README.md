There are three scripts included in this respository, each used when drafting "Testosterone modulates neural responses to Food Cues in Women with Anorexia".

1) 914_bayes.Rmd is the primary script that includes both 2- and 3-factor models referenced in the paper. Baseline characteristics and model fit statistics as described in the supplement
are also included.
